...
export default {
  ...
  methods: {
    ...
    async updateProPic() {
      ...
      this.$axios.put(`/chats/${sessionStorage.userID}/${this.groupId}/Grouphoto`, formData, { headers: { 'Authorization': `${sessionStorage.token}` } })
        .then(response => {
    ...
    async updateGroupName() {
      ...
      try {
        ...
        let _ = await this.$axios.put(`/chats/${sessionStorage.userID}/${this.groupId}/Groupname`, { groupName: this.newGroupname }, { headers: { 'Authorization': `${sessionStorage.token}` } })
    ...
    leaveGroup() {
      ...
      this.$axios.delete(`/chats/${sessionStorage.userID}/${this.groupId}/leavgroup`, { headers: { 'Authorization': `${sessionStorage.token}` } })
        .then(() => {
